...
**IoT Hub** is an Azure service that enables you to ingest high volumes of telemetry from your IoT devices into the cloud for storage or processing. You can find more references about IoT Hub from ```https://docs.microsoft.com/en-us/azure/iot-hub/about-iot-hub```.
