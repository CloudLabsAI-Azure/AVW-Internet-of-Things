...
1. Navigate to your Linux machine **linuxagentvm-{deployment-id}** in Azure Portal by selecting Resource groups from the Azure home page, and then select the **linuxagentvm-{deployment-id}** Linux VM resource from the list.
